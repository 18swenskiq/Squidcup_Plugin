...
namespace Squidcup
{
    ...
    public partial class Squidcup
    {
        ...
        [ConsoleCommand("squidcup_addplayer", "Adds player to the provided team")]
        ...
        public void OnAddPlayerCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            {
                command.ReplyToCommand("Usage: squidcup_addplayer <steam64> <team> \"<name>\"");
                return; 
            }
            ...
            if (playerTeam == "team1")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, squidcupTeam1.teamPlayers);
            } else if (playerTeam == "team2")
            {
                success = AddPlayerToTeam(playerSteamId, playerName, squidcupTeam2.teamPlayers);
        ...
        [ConsoleCommand("squidcup_removeplayer", "Removes the player from all the teams")]
        ...
        {
            if (squidcupTeam1.teamPlayers != null && squidcupTeam1.teamPlayers[steamId] != null) return false;
            if (squidcupTeam2.teamPlayers != null && squidcupTeam2.teamPlayers[steamId] != null) return false;
        ...
        {
            List<JToken?> teams = [squidcupTeam1.teamPlayers, squidcupTeam2.teamPlayers, matchConfig.Spectators];
