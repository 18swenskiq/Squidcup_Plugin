...
namespace Squidcup
{
    ...
    {
        public const string sleepCfgPath = "Squidcup/sleep.cfg";
        ...
        public void StartSleepMode()
        {
            ...
            Log($"[StartSleepMode] Squidcup deactivated!");
        }
        ...
        public void OnSleepCommand(CCSPlayerController? player, CommandInfo? command)
        {
            ...
            if (matchStarted)
            {
                ...
                ReplyToUserCommand(player, Localizer["squidcup.sleep.sleepwhenmatchstared"]);
                return;
            }
            StartSleepMode();
        }
