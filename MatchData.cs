...
public class SquidcupTeamWrapper
{
    [JsonPropertyName("id")]
    ...
    public SquidcupTeamWrapper(string id, string name)
    {
        Id = id;
        Name = name;
    }
...
public class SquidcupStatsTeam : SquidcupTeamWrapper
{
    ...
    public SquidcupStatsTeam(string id, string name, int seriesScore, int score, int scoreCt, int scoreT, List<StatsPlayer> players) : base(id, name)
    {
